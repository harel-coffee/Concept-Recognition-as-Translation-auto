...
To implement or use the models created here, start by cloning this github repository. Some files are too large to upload here so we uploaded them to Zenodo: (DOI: 10.5281/zenodo.4062444). All files can be accessed here on Zenodo: https://zenodo.org/record/4062444#.YT-RwtNKhch. Download all the files from Zenodo also and put all the .tar.gz files within the Concept-Recognition-as-Translation/ folder. 
